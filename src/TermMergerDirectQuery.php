...
class TermMerger implements TermMergerInterface {
  ...
  public function mergeIntoTerm(array $termsToMerge, TermInterface $targetTerm) {
    ...
    $this->updateDatabaseReferences($termsToMerge, $targetTerm);
  ...
  /**
   * Updates the reference to the term id in the database
   ...
   */
  private function updateDatabaseReferences(array $fromTerms, TermInterface $toTerm) {
    // Todo implement queries to update
  }
